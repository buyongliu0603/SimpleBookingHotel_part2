...
class _EditHotelState extends State<EditHotel> {
  ...
  void initState() {
    ...
    roomEditingController.text = widget.hotels.totalRooms;
  ...
  updateProduct() {
    ...
    if (locationEditingController.text.length < 10) {
      Toast.show("Please enter hotel location", context,
          duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
      return;
    }
    if (descriptionEditingController.text.length < 10) {
    ...
    if (_image!=null){
      ...
      http.post(server+"/php/update_hotles.php", body: {
      "id": widget.hotels.id,
      "name": nameEditingController.text,
      "quantity": locationEditingController.text,
      "description": descriptionEditingController.text,
      "budget": budget.toStringAsFixed(2),
      "totalrooms": roomEditingController.text,
