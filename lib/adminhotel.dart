...
class _AdminHotelState extends State<AdminHotel> {
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Column(
                              children: <Widget>[
                                FlatButton(
                                    onPressed: () => _sortItem("Free Breakfast"),
                                    color: Color.fromRGBO(101, 255, 218, 50),
                                    padding: EdgeInsets.all(10.0),
                                    child: Column(
                                      // Replace with a Row for horizontal icon + text
                            ...
                            Column(
                              children: <Widget>[
                                FlatButton(
                                    onPressed: () => _sortItem("Free Collection"),
                                    color: Color.fromRGBO(101, 255, 218, 50),
                                    padding: EdgeInsets.all(10.0),
                                    child: Column(
                                      // Replace with a Row for horizontal icon + text
  ...
  void _loadSingleProduct(String id) {
    String urlLoadJobs = server + "/php/load_hotel.php";
  ...
  _onHotelDetail(int index) async {
    ...
    Hotel hotel = new Hotel(
        ...
        totalRooms: hoteldata[index]['totalRooms'],
      ...
      items: [
        ...
        PopupMenuItem(
          child: GestureDetector(
              onTap: () =>
                  {Navigator.of(context).pop(), _onHotelDetail(index)},
              child: Text(
                "Update Hotel?",
                style: TextStyle(
                  color: Colors.black,
